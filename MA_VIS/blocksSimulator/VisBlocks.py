...
class BlocksWindow:
    def __init__(self, screen, agents, blocks):
        ...
        self.background_image = pygame.image.load('blocksSimulator/images/table.png')  # Replace with your image file
        ...
        self.hand_image = pygame.image.load('blocksSimulator/images/hand.png')  # Load the hand image
