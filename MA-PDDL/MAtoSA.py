...
if __name__ == '__main__':
    domain = r"examples\Blocks\domain-a4.pddl"
    problem = r"examples\Blocks\problem-a4.pddl"
    ...
    satoma.generate("outputs\\WithObjectsConversion\\Blocks\\domain_4_agents.pddl", "outputs\\WithObjectsConversion\\Blocks\\problem_4_agents.pddl")
