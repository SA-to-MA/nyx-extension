...
(:action accelerate&decelerate&no-op_agent
...
(:action decelerate&decelerate&no-op_agent
:parameters (?a1 - agent ?a2 - agent ?a3 - agent)
:precondition (and
(running ?a1 )
(> (a ?a1 )(down_limit ?a1 ))
...
(:action decelerate&no-op_agent&no-op_agent
:parameters (?a1 - agent ?a2 - agent ?a3 - agent)
:precondition (and
(running ?a1 )
(> (a ?a1 )(down_limit ?a1 ))
...
(:action accelerate&no-op_agent&no-op_agent
:parameters (?a1 - agent ?a2 - agent ?a3 - agent)
:precondition (and
(running ?a1 )
(< (a ?a1 )(up_limit ?a1 ))
...
(:action accelerate&accelerate&stop
:parameters (?a1 - agent ?a2 - agent ?a3 - agent)
:precondition (and
(running ?a1 )
(< (a ?a1 )(up_limit ?a1 ))
...
(:action accelerate&decelerate&decelerate
:parameters (?a1 - agent ?a2 - agent ?a3 - agent)
:precondition (and
(running ?a1 )
(< (a ?a1 )(up_limit ?a1 ))
...
(:action no-op_agent&no-op_agent&stop
:parameters (?a1 - agent ?a2 - agent ?a3 - agent)
:precondition (and
(= (v ?a3 )0 )
(>= (d ?a3 )30 )
...
(:action decelerate&no-op_agent&stop
:parameters (?a1 - agent ?a2 - agent ?a3 - agent)
:precondition (and
(running ?a1 )
(> (a ?a1 )(down_limit ?a1 ))
...
(:action accelerate&no-op_agent&stop
:parameters (?a1 - agent ?a2 - agent ?a3 - agent)
:precondition (and
(running ?a1 )
(< (a ?a1 )(up_limit ?a1 ))
...
(:action accelerate&accelerate&no-op_agent
:parameters (?a1 - agent ?a2 - agent ?a3 - agent)
:precondition (and
(running ?a1 )
(< (a ?a1 )(up_limit ?a1 ))
