...
(:action no-op_agent&return_wooden_pogo
:parameters (?a1 - agent ?a2 - agent)
:precondition (and
...
(:action craft_plank&no-op_agent
:parameters (?a1 - agent ?a2 - agent)
:precondition (and
(>= (count_log_in_inventory )1 )
(agent_free ?a1 )
...
(:action craft_stick&no-op_agent
:parameters (?a1 - agent ?a2 - agent)
:precondition (and
(>= (count_planks_in_inventory )2 )
(agent_free ?a1 )
...
(:action no-op_agent&return_tree_tap
:parameters (?a1 - agent ?a2 - agent)
:precondition (and
(agent_place_tree_tap ?a2 )
(dif_agent ?a1 ?a2 )
...
(:action craft_wooden_pogo&no-op_agent
:parameters (?a1 - agent ?a2 - agent)
:precondition (and
(>= (count_planks_in_inventory )2 )
(>= (count_stick_in_inventory )4 )
...
(:action no-op_agent&return_plank
:parameters (?a1 - agent ?a2 - agent)
:precondition (and
(agent_craft_plank ?a2 )
(dif_agent ?a1 ?a2 )
...
(:action craft_tree_tap&no-op_agent
:parameters (?a1 - agent ?a2 - agent)
:precondition (and
(>= (count_planks_in_inventory )5 )
(>= (count_stick_in_inventory )1 )
...
(:action no-op_agent&return_stick
:parameters (?a1 - agent ?a2 - agent)
:precondition (and
(agent_craft_stick ?a2 )
(dif_agent ?a1 ?a2 )
...
(:action no-op_agent&place_tree_tap
:parameters (?a1 - agent ?a2 - agent)
:precondition (and
(>= (trees_in_map )1 )
(>= (count_tree_tap_in_inventory )1 )
...
(:action no-op_agent&return_sack
:parameters (?a1 - agent ?a2 - agent)
:precondition (and
(agent_get_sack ?a2 )
(dif_agent ?a1 ?a2 )
