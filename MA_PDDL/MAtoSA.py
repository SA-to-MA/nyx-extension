        ...
        try:
            ...
            with open(self.plan, "r") as file:
                ...
                if self.domain_name == "Blocks": # if domain is blocks
                    action_mapping = {'stack': ['agent', 'block', 'block'],
                ...
                elif self.domain_name == "PolyCraft":
                    action_mapping = {
                        'get_log': ['agent'],
                        'craft_plank': ['agent'],
                        'craft_stick': ['agent'],
...
if __name__ == "__main__":
    solve = SolveController("examples/sailing/original_domain.pddl", "examples/sailing/problem.pddl", "Sailing", flags="")
    solve.solve()
